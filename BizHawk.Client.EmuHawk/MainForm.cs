...
using BizHawk.Client.EmuHawk.tools.Ai.Super_Mario_World;
	...
	public partial class MainForm : Form
	{
		...
		private void StepRunLoop_Core(bool force = false)
		{
			...
			if (runFrame || force)
			{
				...
				if (Global.Game.Name == "Super Mario World (USA)") Brain.Evaluate();
				Emulator.FrameAdvance(Global.ActiveController, render, renderSound);
